IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'Protein_Sequences')
	DROP DATABASE [Protein_Sequences]
GO

CREATE DATABASE [Protein_Sequences]  ON (NAME = N'Protein_Sequences_Data', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL\data\Protein_Sequences_Data.MDF' , SIZE = 1545, FILEGROWTH = 10%) LOG ON (NAME = N'Protein_Sequences_Log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL\data\Protein_Sequences_Log.LDF' , SIZE = 1744, FILEGROWTH = 10%)
 COLLATE SQL_Latin1_General_CP1_CI_AS
GO

exec sp_dboption N'Protein_Sequences', N'autoclose', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'bulkcopy', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'trunc. log', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'torn page detection', N'true'
GO

exec sp_dboption N'Protein_Sequences', N'read only', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'dbo use', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'single', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'autoshrink', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'ANSI null default', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'recursive triggers', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'ANSI nulls', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'concat null yields null', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'cursor close on commit', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'default to local cursor', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'quoted identifier', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'ANSI warnings', N'false'
GO

exec sp_dboption N'Protein_Sequences', N'auto create statistics', N'true'
GO

exec sp_dboption N'Protein_Sequences', N'auto update statistics', N'true'
GO

if( (@@microsoftversion / power(2, 24) = 8) and (@@microsoftversion & 0xffff >= 724) )
	exec sp_dboption N'Protein_Sequences', N'db chaining', N'false'
GO
