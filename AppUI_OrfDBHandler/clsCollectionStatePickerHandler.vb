Public Class clsCollectionStatePickerHandler
    ...
    Sub ChangeSelectedCollectionStates( _
        ByVal newStateID As Integer, _
        ByVal selectedCollectionIDList As ArrayList)
    ...
    Private Sub SetupPickerListView(ByVal lvw As ListView, ByVal dt As DataTable)
    ...
    Private Sub SetupPickerListView( _
        ...
        ByVal filterCriteria As String)
    ...
    Sub FillListView(ByVal ListViewToFill As ListView)
        Me.FillFilteredListView(ListViewToFill, "")
    End Sub

    Sub FillFilteredListView(ByVal ListViewToFill As ListView, ByVal FilterString As String)
